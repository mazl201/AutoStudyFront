...
$.ajax({
    url: "/sound/mp3_img_count" + location.search,
    data: {},
    type: "GET",
    // context:null,
    success: function (res) {
        ...
        if (res) {
            if ($("#pagination")) {
                ...
                if (pagecount > pagesize) {
                    if (currentpage > 1) {
                        pagehtml += '<li class="page-item"><a class="page-link" href="/sound/mp3_img?index=' + (currentpage - 1) + '">上一页</a></li>';
                    }
                    for (var i = 0; i < counts; i++) {
                        if (i >= (currentpage - 3) && i < (currentpage + 3)) {
                            if (i == currentpage - 1) {
                                pagehtml += '<li class="active page-item"><a class="page-link" href="/sound/mp3_img?index=' + (i + 1) + '">' + (i + 1) + '</a></li>';
                            } else {
                                pagehtml += '<li class="page-item"><a class="page-link" href="/sound/mp3_img?index=' + (i + 1) + '">' + (i + 1) + '</a></li>';
                            }

                        }
                    }
                    if (currentpage < counts) {
                        pagehtml += '<li class="page-item"><a class="page-link" href="/sound/mp3_img?index=' + (currentpage + 1) + '">下一页</a></li>';
                    }
                }
